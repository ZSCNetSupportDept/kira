...
public class Main {
    ...
    private static final XMLResourceBundle commandLineHelpBundle = ((XMLResourceBundle) getBundle
...
//            }
        ...
        try {
            ...
            if (COMMANDS.DIFF.equalsIgnoreCase(command)) {
                ...
                CommandLineUtils.doDiffToChangeLog(
                        ...
                        createReferenceDatabaseFromCommandParams(commandParams, fileOpener),
                        database,
                        diffOutputControl, objectChangeFilter, StringUtil.trimToNull(diffTypes),
                        StringUtil.trimToNull(changeSetAuthor), StringUtil.trimToNull(changeSetContext), finalSchemaComparisons
                );
                return;
            ...
            if (COMMANDS.LIST_LOCKS.equalsIgnoreCase(command)) {
                ...
                if (liquibaseHubApiKey != null && !hubMode.equalsIgnoreCase("off")) {
    ...
    private boolean isLicenseableCommand(String formatValue) {
        return COMMANDS.ROLLBACK_ONE_CHANGE_SET.equalsIgnoreCase(command) ||
                ...
                (COMMANDS.DIFF.equalsIgnoreCase(command) && formatValue != null && !formatValue.equalsIgnoreCase("txt"));
    }
